...
<div class="head" >
   ...
   <a class="navbar-brand" href="#" style="color:red">
    ...
    <li class="nav-item">
    <a class="nav-link active" href="newcourse.php">New Courses</a>
    </li>
	</ul>
...
<a href="#" class="next">Next &raquo;</a> -->
 <h3 style="color:green;font-family:verdana">NEW COURSES</h3>
<!--  <br>
...
$result = mysqli_query($conn,"SELECT * FROM course order by cid DESC LIMIT 3;");
